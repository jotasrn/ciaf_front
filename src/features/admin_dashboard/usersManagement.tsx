...
// --- SEU COMPONENTE DE FORMULÁRIO CORRIGIDO E INTEGRADO ---
const UserForm = ({
  user,
  onSave,
  onCancel,
  ...
  // Inicialização explícita do estado, garantindo que todas as propriedades existam.
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <select value={formData.role} onChange={(e) => handleInputChange('role', e.target.value as 'admin' | 'professor')} className="w-full px-4 py-2 border border-gray-300 rounded-lg">
...
export default function UsersManagement() {
  ...
  // Esta função agora recebe os dados corretamente inicializados do UserForm
  ...
  return (
    <div className="p-6">
      ...
      {isModalOpen && (
          <Modal isOpen={isModalOpen} onClose={handleCloseModal} title={editingUser?.id ? 'Editar Usuário' : 'Novo Usuário'} size="lg">
