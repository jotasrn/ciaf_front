...
// Tipos
import { Class, User, Sport, Category, ClassSchedule } from '../../types';
...
export default function ClassesManagement() {
  ...
  const handleOpenFormModal = (classItem: Partial<Class> | null = null) => {
    setEditingClass(classItem || { schedule: [] }); // Inicia com array de horários vazio se for novo
