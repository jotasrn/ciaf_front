// src/features/admin_dashboard/usersManagement.tsx
...
// Tipo para os dados do formulário, incluindo a senha opcional
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        ...
        <select value={formData.role || 'professor'} onChange={(e) => handleInputChange('role', e.target.value)} className="w-full px-4 py-2 border border-gray-300 rounded-lg">
  ...
  const handleSaveUser = async (formData: UserFormData) => {
    ...
    try {
      if (id) {
        ...
        // Adicional: Lógica para alterar a senha, se necessário
    ...
    <div className="p-6">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-600 mt-1">Adicione, edite e gerencie admins e professores</p>
        </div>
